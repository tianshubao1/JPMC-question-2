...
if __name__ == '__main__':
    print("Running Part 2.ii Comparisons...")
    ...
    # 1. Loss
    for name in algos:
        axs[0].plot(res[name]['loss'], label=name, linewidth=2)
    ...
    # 2. Grads
    for name in algos:
        axs[1].plot(res[name]['grads'], label=name, linewidth=2)
    ...
    axs[2].bar(algos.keys(), times, color=colors, alpha=0.7)
    ...
    # Save the figure
    plt.savefig("fig_benchmark_comparison.png")
